...
apiResp = k8s.callWS('/apis/certificates.k8s.io/v1beta1/certificatesigningrequests/amq.openunison.svc.cluster.local','print("in echking function for amq cert");print(ws_response_json);java.util.Base64.getDecoder().decode(JSON.parse(ws_response_json).status.certificate);check_ws_response=false;',10);
